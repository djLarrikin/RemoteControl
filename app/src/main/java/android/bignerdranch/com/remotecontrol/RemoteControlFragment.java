...
/**
 * Created by larrikin on 11/13/14.
 */
public class RemoteControlFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        deleteButton.setTextAppearance(getActivity(), R.style.RemoteButton_DeleteButton);
        ...
        enterButton.setTextAppearance(getActivity(), R.style.RemoteButton_EnterButton);
